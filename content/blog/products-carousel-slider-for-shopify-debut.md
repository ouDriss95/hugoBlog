...
title: Modern Products carousel slider for Debut theme
description: I´m going to show you step by step how to implement Product slider within the Debut theme.
date: 2020-11-20
thumbnail: /debut-slider.jpg
---

Product Sliders allows showing all suggested products friendly that match to customer’s expectation via a responsive slider. You can create many product sliders as featured, bestsellers, new arrival products or anything else that you want your customers to see in your store. Also you can create many product sliders that you want to attract customers to make a purchase from your website without any apps, so let me show you step by step

1. From your Shopify admin, go to **Online Store** > **Themes**.
2. Find the Debut theme, and then click **Actions** > **Duplicate**.
...
!(function (i) {
  ...
  $(document).ready(function () {
    $(".slick").slick({
      ...
      arrows: !0,
      prevArrow:
        '<span><i class="slick-arrow-left"><svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-chevron-left" viewBox="0 0 14 14"><path d="M10.129.604a1.125 1.125 0 0 0-1.591 0L3.023 6.12s.049-.049-.003.004l-.082.08c-.439.44-.44 1.153 0 1.592l5.6 5.6a1.125 1.125 0 0 0 1.59-1.59L5.325 7l4.805-4.805c.44-.439.44-1.151 0-1.59z" fill="#fff"/></svg></i></span>',
      nextArrow:
        '<span><i class="slick-arrow-right"><svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-chevron-right" viewBox="0 0 14 14"><path d="M3.871.604c.44-.439 1.152-.439 1.591 0l5.515 5.515s-.049-.049.003.004l.082.08c.439.44.44 1.153 0 1.592l-5.6 5.6a1.125 1.125 0 0 1-1.59-1.59L8.675 7 3.87 2.195a1.125 1.125 0 0 1 0-1.59z" fill="#fff"/></svg></i></span>',
    });
  });
```

**5.** On the same folder which is _Assets_. Create a file called 'slick.css.liquid'
...
**9.** Next, On the left bar, search for a folder called _Layout_ then find a file called 'theme.liquid'.
...
**12.** Next, On the left bar, search for a folder called _Sections_ then create a new file called 'products-slider.liquid'.
