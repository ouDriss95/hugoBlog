...
title: Custom Header With Hide on Scroll Down & Show on Scroll Up
description: You will learn how to re-design your header to a custom one.
date: 2021-03-07
...
**7.** Next, search for a folder called _config_ on the left bar, then click on a file called 'settings_schema.json'
