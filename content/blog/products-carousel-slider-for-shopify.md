...
title: Products carousel slider for Shopify
description: I´m going to show you step by step how to implement Product slider within the Minimal theme.
date: 2020-09-19
...
**6.** On the same folder which is _Assets_. Create another file called 'slick.css.liquid'
...
**10.** Next, On the left bar, search for a folder called _Layout_ then find a file called 'theme.liquid'.
...
**13.** Next, On the left bar, search for a folder called _Sections_ then create a new file called 'products-slider.liquid'.
